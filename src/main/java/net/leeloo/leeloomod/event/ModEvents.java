...
@Mod.EventBusSubscriber(modid = LeelooMod.MOD_ID)
public class ModEvents {
    ...
    public static void equipmentChange(LivingEquipmentChangeEvent event) {
        ...
        ItemStack mHelmet = ModItems.MAUVINITE_HELMET.get().getDefaultInstance();
        ItemStack mChest = ModItems.MAUVINITE_CHESTPLATE.get().getDefaultInstance();
        ItemStack mLeg = ModItems.MAUVINITE_LEGGINGS.get().getDefaultInstance();
        ItemStack mBoot = ModItems.MAUVINITE_BOOTS.get().getDefaultInstance();
        if (event.getEntity() instanceof Player player &&
                (ItemStack.isSameItem(player.getItemBySlot(EquipmentSlot.HEAD), mHelmet)
                        && ItemStack.isSameItem(player.getItemBySlot(EquipmentSlot.LEGS), mLeg)
                        && ItemStack.isSameItem(player.getItemBySlot(EquipmentSlot.CHEST), mChest)
                        && ItemStack.isSameItem(player.getItemBySlot(EquipmentSlot.FEET), mBoot))) {
