package net.leeloo.leeloomod.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        this.dropSelf(ModBlocks.LAVA_SPONGE_BLOCK.get());
        this.dropSelf(ModBlocks.LAVA_SPONGE_BLOCK_FULL.get());
        this.dropSelf(ModBlocks.MAUVINITE_REFINER.get());
        this.dropSelf(ModBlocks.AMBER_BLOCK.get());
        this.dropSelf(ModBlocks.EMBEDDED_AMBER.get());
        this.dropSelf(ModBlocks.EMBEDDED_MAUVINITE.get());
        this.dropSelf(ModBlocks.ENCAPSULATED_MAUVINITE.get());
        this.dropSelf(ModBlocks.STRANGE_STONE.get());
        this.dropSelf(ModBlocks.ETHEREAL_ORE.get());
        //this.dropSelf(ModBlocks.MAUVINITE_ORE.get());
