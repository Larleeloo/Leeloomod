package net.leeloo.leeloomod.entity;

import net.leeloo.leeloomod.LeelooMod;
import net.leeloo.leeloomod.entity.custom.*;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, LeelooMod.MOD_ID);
