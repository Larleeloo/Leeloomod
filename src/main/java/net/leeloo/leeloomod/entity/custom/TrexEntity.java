package net.leeloo.leeloomod.entity.custom;
...
public class TrexEntity extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(TrexEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
       ...
       // this.goalSelector.addGoal(1, new TrexAttackGoal(this, 1.0D, true));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.TREX.get().create(pLevel);
    }
