...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, LeelooMod.MOD_ID);
    ...
    public static final RegistryObject<BlockEntityType<MauviniteRefinerBlockEntity>> MAUVINITE_REFINER_BE =
            BLOCK_ENTITIES.register("mauvinite_refiner_be", () ->
                    BlockEntityType.Builder.of(MauviniteRefinerBlockEntity::new,
                            ModBlocks.MAUVINITE_REFINER.get()).build(null));
