...
import net.leeloo.leeloomod.worldgen.ModPlacedFeatures;
...
public class ModBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(LeelooMod.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, ModPlacedFeatures.LAVA_SPONGE_PLACED_KEY);
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(0xb844b4)
                        .waterFogColor(0xb844b4)
                        .skyColor(0x447AB8)
                        .grassColorOverride(0xB88244)
                        .foliageColorOverride(0x44B848)
                        .fogColor(0xb844b4)
